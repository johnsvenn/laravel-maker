...
class TableParser {
    ...
    private $selects = array('column_name AS Field', 'column_type AS Type', 'is_nullable AS Null', 'column_key AS Key', 'column_default AS Default', 'extra AS Extra', 'data_type AS Data_Type');
